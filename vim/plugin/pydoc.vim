...
" This plugin integrates the pydoc into vim. You can view the documentation of
" a module by using :Pydoc foo.bar.baz or search a word (uses pydoc -k) in the
" documentation by typing PydocSearch foobar. You can also view the
" documentation of the word under the cursor by pressing <leader>pd or the
" WORD (see :help WORD) by pressing <leader>pD. This is very useful if you
