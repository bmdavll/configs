...
if exists("python_highlight_all") && python_highlight_all != 0
  call s:InitVariable("python_highlight_numbers", 1)
  call s:InitVariable("python_highlight_builtins", 1)
  call s:InitVariable("python_highlight_exceptions", 1)
  " call s:InitVariable("python_highlight_space_errors", 1)
endif
...
if exists("python_highlight_builtins")
  ...
  "+
  syn keyword pythonBuiltin    apply basestring coerce compile execfile file
  syn keyword pythonBuiltin    input intern long raw_input reduce unichr xrange
endif
